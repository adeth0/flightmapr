...
export function TopBar({
  ...
  return (
    ...
    >
      ...
      {/* ── Search ───────────────────────────────────────── */}
      <div className="flex-1 min-w-0 relative" style={{ pointerEvents: 'auto' }}>
      ...
      <div className="flex items-center gap-1.5 flex-shrink-0" style={{ pointerEvents: 'auto' }}>
        ...
        {/* Hidden on mobile (<sm) — all layers accessible via Layers dropdown */}
        ...
        <a
          ...
          className="flex items-center gap-1.5 px-3 py-2.5 rounded-2xl text-xs font-bold text-black whitespace-nowrap transition-all shadow-[0_0_16px_rgba(0,255,204,0.35)]"
          style={{ background: 'linear-gradient(135deg, #00ffcc 0%, #10b981 100%)', pointerEvents: 'auto' }}
        >
          <span className="text-sm leading-none">✈️</span>
          <span className="hidden sm:inline">Support FlightMapr</span>
